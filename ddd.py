# mcpserver.py - Fixed version based on your working SSE client
...
def create_mcp_server(driver: AsyncDriver, database: str) -> FastMCP:
    """Create MCP server with SSE transport (matching your working client)."""
...
async def run_mcp_server():
    """Main server function with SSE transport (matching your working client)."""
    driver = None
    try:
        # Create Neo4j driver
        ...
        # Use SSE transport to match your working client
