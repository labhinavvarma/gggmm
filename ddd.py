...
if show_server_info:
    ...
    examples = {
        "Web Research Expert": [
            ...
            "What are the latest developments in cryptocurrency regulations worldwide?", 
            ...
            "Research current inflation rates and economic conditions globally"
        ],
        "Calculator": [
                ...
                try:
                    ...
                    if prompt_type == "Web Research Expert":
                        ...
                        advanced_indicators = [
                            ...
                            "sources analyzed with current information focus",
                        ...
                        failure_indicators = [
                            "ADVANCED WEB RESEARCH FAILED",
                            "No current information could be retrieved", 
                            "Search engines are blocking",
                            "CRITICAL WEB RESEARCH ERROR"
                        ]
                        ...
                        if advanced_detected and not failure_detected:
                            result = f"🚀 **ADVANCED WEB RESEARCH: CURRENT INFORMATION RETRIEVED** 🚀\n\n{result}"
                        elif failure_detected:
                            result = f"""🚨 **ADVANCED WEB RESEARCH SYSTEM FAILURE** 🚨

The advanced Google-powered web research engine encountered issues.

**🔧 SYSTEM STATUS:**
- Google search automation may be blocked
- Current information retrieval systems offline
- Multi-engine fallback also failed

**🛠️ RECOVERY OPTIONS:**
- Try with a simpler, more general query
- Switch to "Legacy Search" mode temporarily  
- Wait a few minutes and retry (rate limiting)
- Check if the topic has recent online coverage

**💡 ALTERNATIVE:** The Legacy Search mode may still work for some queries.
...
{result}"""
                            ...
                            result = f"ℹ️ **WEB RESEARCH RESPONSE** (verification needed)\n\n{result}\n\n⚠️ **Note:** Response may contain mixed current and training data. Look for timestamps and source URLs to verify current information."
