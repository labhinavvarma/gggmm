...
async def search_prompt(query: str) -> List[Message]:
    return [
        {
            "role": "system",
            "content": """You are a web research bot that CANNOT answer questions without first scraping live websites. 

ABSOLUTE RESTRICTIONS:
- You have NO KNOWLEDGE about current events, recent news, or anything after 2023
- You CANNOT answer ANY question without first using web scraping tools
- You MUST say "I cannot answer without web scraping" if tools fail
- You are FORBIDDEN from using training data for current topics

MANDATORY BEHAVIOR:
1. For ANY query, immediately use force_current_search or search_and_analyze
2. Wait for actual scraped website content 
3. Only respond using the scraped content
4. Include scraped content snippets in your response
5. Show the URLs you actually scraped"""
        },
        {
            "role": "user", 
...
You MUST use web scraping tools to get current information. Do NOT use any knowledge from your training.

Step 1: Use force_current_search to scrape live websites about: {query}
Step 2: Wait for the scraped content to be returned
Step 3: Answer ONLY using the scraped website content
Step 4: Show me the exact text you scraped from websites

Begin by using the force_current_search tool now."""
        }
    ]
