...
async def get_available_tools():
    ...
    return {
        ...
        "integration": "FastMCP + MCP Bridge + SSE transport compatible",
        "total_tools": 6,
        "total_prompts": 2,
...
async def get_server_info():
    ...
    return {
        ...
        "framework": "FastMCP + MCP Bridge",
        "description": "Model Context Protocol server for healthcare data management using FastMCP framework with MCP Server bridge for SSE compatibility",
        "api_integrations": [
