...
if show_server_info:
    ...
    with st.sidebar.expander("🛠 Tools", expanded=False):
        tool_categories = {
            ...
            "Search & Web": ["search_and_analyze", "duckduckgo_search", "fetch_content", "web_search", "real_search"],
            "Weather": ["get_weather"],
    ...
    examples = {
        ...
        "Search Expert": [
            "Search for the latest news about artificial intelligence and summarize the key developments from the articles",
            "Find detailed information about climate change impacts in 2024, read the content, and provide a comprehensive analysis",
            "Look up recent developments in renewable energy technology, fetch the content, and explain the innovations",
            "Search for current stock market trends, analyze the articles, and explain the market conditions",
            "Find articles about machine learning applications in healthcare, read them, and summarize the findings",
            "Research the latest developments in quantum computing, fetch content from top sources, and explain the breakthroughs",
            "Search for information about electric vehicle adoption rates, read the articles, and provide detailed statistics and analysis"
        ],
        "No Context": [
    ...
    if prompt_type == "Weather":
        ...
        with st.sidebar.expander("🔍 Search Tips", expanded=False):
            st.info("""
            **Search Expert Process:**
            1. 🔍 Searches DuckDuckGo for relevant pages
            2. 📄 Fetches actual content from top results  
            3. 📊 Analyzes and summarizes the content
            4. 📝 Provides detailed answers with citations
            
            **Available Tools:**
            • search_and_analyze (recommended - does everything in one step)
            • DuckDuckGo search + manual content fetching
            • Multi-engine search backup
            • Real-time information retrieval
            
            **Best Results:** Ask for analysis, summaries, or detailed explanations. The system will automatically fetch and read content from relevant websites.
            """)
        ...
        async def process_query(query_text):
            with st.chat_message("assistant"):
                ...
                try:
                    ...
                    message_placeholder.text("🛠️ Tools loaded, creating agent...")
                    ...
                    if prompt_name is None:
                        ...
                        message_placeholder.text("📝 Loading expert prompt...")
