                    ...
                    if prompt_type == "Web Search":
                        if debug_raw:
                            ...
                            prompt_from_server = [
                                {
                                    "role": "user",
                                    "content": f"""You are debugging SerpApi responses. Use the SerpApiRawDebug tool to see the complete raw JSON response from SerpApi.

                                    IMPORTANT: Use the SerpApiRawDebug tool with these parameters:
                                    - query: "{query_text}"
                                    - api_key: "{SERPAPI_API_KEY}"

                                    This will show you the complete raw JSON response from SerpApi so you can see exactly what data is being returned."""
                                }
                            ]
                        else:
                            # Normal search mode
                            prompt_from_server = [
                                {
                                    ...
                                    Steps:
                                    1. Use SerpApiSearch to search for: {query_text}
