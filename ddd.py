    ...
    if st.session_state.analysis_results and st.session_state.analysis_results.get("chatbot_ready", False) and st.session_state.chatbot_context:
        ...
        prompt_categories = {
            ...
            "📊 Analysis & Graphs": [
                ...
                "Create a comprehensive health overview graph",
        ...
        with col1:
            if st.button("📈 Timeline", use_container_width=True, key="quick_timeline"):
                st.session_state.selected_prompt = "Create a medication timeline chart"
                st.rerun()
        
        with col2:
            if st.button("🥧 Pie Chart", use_container_width=True, key="quick_pie"):
                st.session_state.selected_prompt = "Show me a pie chart of medications"
                st.rerun()
        ...
        st.markdown("• Advanced graph generation")
...
if st.session_state.analysis_results and not st.session_state.analysis_running:
    ...
    # Enhanced results sections would go here...
    # (Similar to your existing results display code)
    ...
    # Display enhanced trajectory if available
