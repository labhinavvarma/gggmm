# mcpserver.py - UPDATED VERSION - Replace your existing file with this
...
def create_mcp_server(driver: AsyncDriver, database: str) -> FastMCP:
    """Create MCP server with HTTP transport (no more deprecated SSE)."""
    # Remove deprecated stateless_http parameter
...
async def run_mcp_server():
    """Main server function using HTTP transport (not deprecated SSE)."""
    driver = None
    try:
        # Create Neo4j driver
        ...
        # CRITICAL FIX: Use HTTP transport instead of deprecated SSE
