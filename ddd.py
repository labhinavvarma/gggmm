...
async def hedis_prompt(query: str)-> List[Message]:
    return [
        {
            "role": "system",
            "content": """You are an expert in HEDIS system. HEDIS is a set of standardized measures that aim to improve healthcare quality by promoting accountability and transparency.
