...
if show_server_info:
    ...
    with st.sidebar.expander("🛠 Tools", expanded=False):
        tool_categories = {
            ...
            "Search & Web": ["block_old_data_responses", "mandatory_web_search", "verify_web_scraping", "force_current_search", "search_and_analyze", "duckduckgo_search", "fetch_content", "web_search", "real_search"],
            "Weather": ["get_weather"],
                ...
                try:
                    ...
                    if prompt_type == "Search Expert":
                        ...
                        scraping_indicators = [
                            ...
                            "Scraped at:",
                            "block_old_data_responses",
                            "mandatory_web_search",
                            "force_current_search",
                            "Website scraped:",
                            "Retrieved:",
                        ...
                        if scraping_detected:
                            result = f"🔓 **OLD DATA BLOCKING SYSTEM ACTIVATED** ✅\n\n{result}"
                        else:
                            # Strong warning if no scraping detected
...
2. Check the mandatory web scraping test in the sidebar
