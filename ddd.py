...
import httpx
from mcp import ClientSession, StdioServerParameters  # Corrected import
...
class HealthMCPClient:
    def __init__(self):
        self.session: Optional[ClientSession] = None  # Changed from Client to ClientSession
    ...
    async def connect_to_mcp_server(self, command: List[str] = None):
        ...
        try:
            ...
            async with stdio_client(server_params) as (read_stream, write_stream):
                async with ClientSession(read_stream, write_stream) as session:  # Updated to ClientSession
    ...
    async def test_all_tool(self):
        ...
        try:
            result = await self.session.call_tool("all", {})
    ...
    async def test_token_tool(self):
        ...
        try:
            result = await self.session.call_tool("token", {})
            print("✅ Tool execution successful!")
            print("📋 Result:")
            for content in result.content:
                if hasattr(content, 'text'):
    ...
    async def test_medical_submit_tool(self):
        ...
        try:
            ...
            result = await self.session.call_tool("medical_submit", patient_data)
            print("✅ Tool execution successful!")
            print("📋 Result:")
            for content in result.content:
                if hasattr(content, 'text'):
    ...
    async def test_pharmacy_submit_tool(self):
        ...
        try:
            ...
            result = await self.session.call_tool("pharmacy_submit", patient_data)
            print("✅ Tool execution successful!")
            print("📋 Result:")
            for content in result.content:
                if hasattr(content, 'text'):
    ...
    async def test_mcid_search_tool(self):
        ...
        try:
            ...
            result = await self.session.call_tool("mcid_search", patient_data)
            print("✅ Tool execution successful!")
            print("📋 Result:")
            for content in result.content:
                if hasattr(content, 'text'):
    ...
    async def test_get_all_healthcare_data_tool(self):
        ...
        try:
            ...
            result = await self.session.call_tool("get_all_healthcare_data", patient_data)
            print("✅ Tool execution successful!")
            print("📋 Result:")
            for content in result.content:
                if hasattr(content, 'text'):
    ...
    async def test_health_details_prompt(self):
        ...
        try:
            ...
            result = await self.session.get_prompt("health-details", {"query": query})
    ...
    async def test_healthcare_summary_prompt(self):
        ...
        try:
            ...
            result = await self.session.get_prompt("healthcare-summary", {"query": query})
            print("✅ Prompt execution successful!")
            print("📋 Generated Prompt:")
            for message in result.messages:
                print(f"Role: {message.role}")
    ...
    async def run_all_tool_tests(self):
        ...
        try:
            print("\n--- Medical Submit Test ---")
            result = await self.session.call_tool("medical_submit", sample_patient)
            print("✅ Medical submit successful")
            
            print("\n--- Pharmacy Submit Test ---")
            result = await self.session.call_tool("pharmacy_submit", sample_patient)
            print("✅ Pharmacy submit successful")
            
            print("\n--- MCID Search Test ---")
            result = await self.session.call_tool("mcid_search", sample_patient)
    ...
    async def test_sample_patient_data(self):
        ...
        for i, patient in enumerate(sample_patients, 1):
            ...
            try:
                ...
                result = await self.session.call_tool("get_all_healthcare_data", patient)
