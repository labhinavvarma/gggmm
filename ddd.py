...
@mcp.tool(
       ...
       ,description="""
        ...
        Args:
               ...
               debug_raw (bool): If true, returns complete raw JSON response from SerpApi (default: false)
        """
)
async def serpapi_search(query: str, api_key: str, location: str = "", num_results: int = 5, debug_raw: bool = False) -> str:
