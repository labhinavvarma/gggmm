        ...
        <div style="background: rgba(255, 255, 255, 0.1); padding: 1.5rem; border-radius: 8px; margin: 1rem 0;">
            ...
            <div style="margin: 1rem 0; border-top: 1px solid rgba(255,255,255,0.2); padding-top: 1rem;">
                ...
                <div class="research-step">
                    ...
                    <div class="research-step-text">Deidentifying Claims Data</div>
                </div>
                <div class="research-step">
                    <div class="research-step-icon step-pending">○</div>
                    <div class="research-step-text">Extracting Claims Fields</div>
                </div>
                <div class="research-step">
                    <div class="research-step-icon step-pending">○</div>
                    <div class="research-step-text">Extracting Health Entities</div>
                </div>
                <div class="research-step">
                    <div class="research-step-icon step-pending">○</div>
                    <div class="research-step-text">Analyzing Health Trajectory</div>
                </div>
                <div class="research-step">
                    <div class="research-step-icon step-pending">○</div>
                    <div class="research-step-text">Generating Summary</div>
                </div>
                <div class="research-step">
                    <div class="research-step-icon step-pending">○</div>
                    <div class="research-step-text">Predicting Heart Attack Risk</div>
                </div>
                <div class="research-step">
                    <div class="research-step-icon step-pending">○</div>
    ...
    if not is_valid:
        ...
        if st.session_state.agent is None:
            try:
                ...
                with st.spinner("Testing agent connections..."):
                    try:
                        # Quick test to ensure agent is working
                        test_patient = {
                            "first_name": "test",
                            "last_name": "test", 
                            "ssn": "123456789",
                        ...
                        st.warning(f"⚠️ Agent initialized but some services may be unavailable: {str(test_error)}")
        ...
        with st.spinner("🔬 Executing deep research analysis..."):
            try:
                # Execute actual analysis (remove simulation)
