...
@mcp.tool(
       ...
       ,description="""
        DEBUG TOOL: Always returns raw SerpApi JSON response for debugging purposes.
        Use this tool to see exactly what SerpApi is returning.
...
async def serpapi_raw_debug(query: str, api_key: str) -> str:
    """Debug tool that always returns raw SerpApi JSON response"""
    ...
    try:
        ...
        import json
        return f"🔧 RAW SERPAPI DEBUG FOR: '{query}'\n\nParams used: {json.dumps(params, indent=2)}\n\nResponse:\n{json.dumps(results, indent=2, ensure_ascii=False)}"
