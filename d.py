...
if st.session_state.analysis_running:
    ...
    <div class="analysis-progress">
        <h3>🔬 Deep Research Analysis in Progress</h3>
        <p>Processing comprehensive claims data analysis...</p>
        <p><em>This may take 30-60 seconds. Please wait...</em></p>
    </div>
    """, unsafe_allow_html=True)
...
if submitted and not st.session_state.analysis_running:
    ...
    if not is_valid:
        ...
        st.warning("⏳ This may take 30-60 seconds. Processing comprehensive claims data...")
