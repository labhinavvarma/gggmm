...
class HealthDataProcessor:
    ...
    # NEW METHODS FOR CODE EXPLANATIONS
    def get_service_code_explanation(self, service_code: str) -> str:
        """Get LLM explanation for health service code (1-2 lines)"""
        ...
        try:
            ...
            response = self.api_integrator.call_llm(prompt, "You are a medical coding expert. Provide brief, accurate explanations for healthcare codes in 1-2 lines.")
            ...
            logger.warning(f"Error getting service code explanation: {e}")
            return "Explanation unavailable"
    
    def get_diagnosis_code_explanation(self, diagnosis_code: str) -> str:
        """Get LLM explanation for diagnosis code (1-2 lines)"""
        ...
        try:
            ...
            response = self.api_integrator.call_llm(prompt, "You are a medical coding expert. Provide brief, accurate explanations for ICD-10 diagnosis codes in 1-2 lines.")
            ...
            logger.warning(f"Error getting diagnosis code explanation: {e}")
            return "Explanation unavailable"
    
    def get_ndc_code_explanation(self, ndc_code: str) -> str:
        """Get LLM explanation for NDC code (1-2 lines)"""
        ...
        try:
            ...
            response = self.api_integrator.call_llm(prompt, "You are a pharmacy expert. Provide brief, accurate explanations for NDC (National Drug Code) numbers in 1-2 lines.")
            ...
            logger.warning(f"Error getting NDC code explanation: {e}")
            return "Explanation unavailable"
    
    def get_medication_explanation(self, medication_name: str) -> str:
        """Get LLM explanation for medication/label name (1-2 lines)"""
        ...
        try:
            ...
            response = self.api_integrator.call_llm(prompt, "You are a pharmacist. Provide brief, accurate explanations for medications in 1-2 lines focusing on primary use and mechanism.")
            ...
            logger.warning(f"Error getting medication explanation: {e}")
            return "Explanation unavailable"
